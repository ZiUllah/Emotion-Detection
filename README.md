...
Download NLTK data: The nltk library requires stopwords and punkt tokenizers. These will be downloaded automatically when running the 

Streamlit app, but you can also do it manually:
...
The Jupyter/Colab notebook (Emotion_Prediction_Project.ipynb) contains all the steps from data loading and preprocessing to model 
training and evaluation. You can run cells sequentially to reproduce the results and train the model.
